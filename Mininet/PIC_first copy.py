...
def myNetwork():
    ...
    ap1 = net.addAccessPoint('ap1', range=6, cls=OVSKernelAP, ssid='ap1-ssid', channel='1', mode='g', position='10.0,10.0,0')
    ap2 = net.addAccessPoint('ap2', range=6, cls=OVSKernelAP, ssid='ap2-ssid', channel='1', mode='g', position='20.0,10.0,0')
